...
Partial Public Class gymdataDataSet
    ...
    Partial Public Class adminDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddadminRow(ByVal username As String, ByVal password As String, ByVal numero As Integer) As adminRow
            Dim rowadminRow As adminRow = CType(Me.NewRow,adminRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, username, password, numero}
    ...
    Partial Public Class adminRow
        ...
        Public Property numero() As Integer
            Get
                Try 
                    Return CType(Me(Me.tableadmin.numeroColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'numero' in table 'admin' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableadmin.numeroColumn) = value
            End Set
        End Property
        ...
        Public Function IsnumeroNull() As Boolean
            Return Me.IsNull(Me.tableadmin.numeroColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetnumeroNull()
            Me(Me.tableadmin.numeroColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace gymdataDataSetTableAdapters
    ...
    Partial Public Class adminTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `admin` WHERE ((`N°` = ?) AND ((? = 1 AND `username` IS NULL) OR (`us"& _ 
                "ername` = ?)) AND ((? = 1 AND `password` IS NULL) OR (`password` = ?)) AND ((? ="& _ 
                " 1 AND `numero` IS NULL) OR (`numero` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `admin` (`username`, `password`, `numero`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `admin` SET `username` = ?, `password` = ?, `numero` = ? WHERE ((`N°` = ?)"& _ 
                " AND ((? = 1 AND `username` IS NULL) OR (`username` = ?)) AND ((? = 1 AND `passw"& _ 
                "ord` IS NULL) OR (`password` = ?)) AND ((? = 1 AND `numero` IS NULL) OR (`numero"& _ 
                "` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.fitness_form.My.MySettings.Default.gymdataConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [N°], username, [password], numero FROM admin"
        ...
        Public Overloads Overridable Function Delete(ByVal _Original_N_ As Integer, ByVal Original_username As String, ByVal Original_password As String, ByVal Original_numero As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal username As String, ByVal password As String, ByVal numero As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal username As String, ByVal password As String, ByVal numero As Global.System.Nullable(Of Integer), ByVal _Original_N_ As Integer, ByVal Original_username As String, ByVal Original_password As String, ByVal Original_numero As Global.System.Nullable(Of Integer)) As Integer
            If (username Is Nothing) Then
